...
HMC_FR <- function(Labels, X_A, X_B, X_AB, n_A, n_B, n_AB, MCMC_iters, basis_degree, boundary_knots, internal_knots, Warm_block1 = 500L, Warm_block2 = 500L, Leapfrog_steps = 10L, I_A_shape = 40, I_A_rate = 1, I_B_shape = 40, I_B_rate = 1, sigma_A_mean = 6.32, sigma_A_shape = 1, sigma_B_mean = 6.32, sigma_B_shape = 1, alpha = 1, beta = 0.05, step_size_sigma = 0.001, step_size_FR = 0.001) {
    .Call('_NeuralComp_HMC_FR', PACKAGE = 'NeuralComp', Labels, X_A, X_B, X_AB, n_A, n_B, n_AB, MCMC_iters, basis_degree, boundary_knots, internal_knots, Warm_block1, Warm_block2, Leapfrog_steps, I_A_shape, I_A_rate, I_B_shape, I_B_rate, sigma_A_mean, sigma_A_shape, sigma_B_mean, sigma_B_shape, alpha, beta, step_size_sigma, step_size_FR)
}
...
Mixed_Sampler_TI <- function(X_A, X_B, X_AB, n_A, n_B, n_AB, MCMC_iters, basis_degree, boundary_knots, internal_knots, Warm_block1 = 500L, Warm_block2 = 1000L, Leapfrog_steps = 10L, I_A_mean = 40, I_A_shape = 1, I_B_mean = 40, I_B_shape = 1, sigma_A_mean = 6.32, sigma_A_shape = 1, sigma_B_mean = 6.32, sigma_B_shape = 1, delta_shape = 0.01, delta_rate = 0.1, step_size_theta = 0.001, step_size_FR = 0.001, step_size_labels = 0.0001, delta_proposal_mean = -2, delta_proposal_sd = 0.3, alpha_labels = 0.2, alpha = 1, beta = 0.005, delta_adaption_block = 100L, theta_adaption_block = 500L, M_proposal = 10L, n_Ensambler_sampler = 5L, Mass_mat = NULL) {
    .Call('_NeuralComp_Mixed_Sampler_TI', PACKAGE = 'NeuralComp', X_A, X_B, X_AB, n_A, n_B, n_AB, MCMC_iters, basis_degree, boundary_knots, internal_knots, Warm_block1, Warm_block2, Leapfrog_steps, I_A_mean, I_A_shape, I_B_mean, I_B_shape, sigma_A_mean, sigma_A_shape, sigma_B_mean, sigma_B_shape, delta_shape, delta_rate, step_size_theta, step_size_FR, step_size_labels, delta_proposal_mean, delta_proposal_sd, alpha_labels, alpha, beta, delta_adaption_block, theta_adaption_block, M_proposal, n_Ensambler_sampler, Mass_mat)
}
...
FFBS_ensemble <- function(X_AB, n_AB, theta, basis_coef_A, basis_coef_B, basis_degree, boundary_knots, internal_knots, MCMC_iters, step_size = 0.0001, num_evals = 10000L, delta_proposal_mean = -2.525729, delta_proposal_sd = 0.005, M_proposal = 10L, delta_shape = 0.5, delta_rate = 0.1, alpha = 0.2) {
    .Call('_NeuralComp_FFBS_ensemble', PACKAGE = 'NeuralComp', X_AB, n_AB, theta, basis_coef_A, basis_coef_B, basis_degree, boundary_knots, internal_knots, MCMC_iters, step_size, num_evals, delta_proposal_mean, delta_proposal_sd, M_proposal, delta_shape, delta_rate, alpha)
}
