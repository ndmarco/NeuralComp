...
FR_CI <- function(time, basis_degree, boundary_knots, internal_knots, basis_coef_A_samp, basis_coef_B_samp, burnin_prop = 0.3, alpha = 0.05) {
    .Call('_NeuralComp_FR_CI', PACKAGE = 'NeuralComp', time, basis_degree, boundary_knots, internal_knots, basis_coef_A_samp, basis_coef_B_samp, burnin_prop, alpha)
}

HMC_TI <- function(Labels, X_A, X_B, X_AB, n_A, n_B, n_AB, MCMC_iters, basis_degree, boundary_knots, internal_knots, Warm_block = 500L, Leapfrog_steps = 10L, sigma_A_mean = 6.32, sigma_A_shape = 1, sigma_B_mean = 6.32, sigma_B_shape = 1, alpha = 1, beta = 0.005, mu_prior_mean = 4, mu_prior_var = 1, eps_step = 0.001, step_size = 0.001, step_size_delta = 0.00005) {
...
HMC_FR <- function(Labels, X_A, X_B, X_AB, n_A, n_B, n_AB, MCMC_iters, basis_degree, boundary_knots, internal_knots, Warm_block = 500L, Leapfrog_steps = 10L, sigma_A_mean = 6.32, sigma_A_shape = 1, sigma_B_mean = 6.32, sigma_B_shape = 1, alpha = 0.1, beta = 0.1, mu_prior_mean = 4, mu_prior_var = 0.1, eps_step = 0.001, step_size_sigma = 0.001, step_size_FR = 0.1) {
    .Call('_NeuralComp_HMC_FR', PACKAGE = 'NeuralComp', Labels, X_A, X_B, X_AB, n_A, n_B, n_AB, MCMC_iters, basis_degree, boundary_knots, internal_knots, Warm_block, Leapfrog_steps, sigma_A_mean, sigma_A_shape, sigma_B_mean, sigma_B_shape, alpha, beta, mu_prior_mean, mu_prior_var, eps_step, step_size_sigma, step_size_FR)
}
...
Mixed_Sampler <- function(X_A, X_B, X_AB, n_A, n_B, n_AB, MCMC_iters, Warm_block1 = 200L, Warm_block2 = 300L, init_position = NULL, Leapfrog_steps = 10L, I_A_shape = 40, I_A_rate = 1, I_B_shape = 40, I_B_rate = 1, sigma_A_mean = 6.32, sigma_A_shape = 1, sigma_B_mean = 6.32, sigma_B_shape = 1, delta_shape = 0.01, delta_rate = 0.1, eps_step = NULL, step_size = 0.001, step_size_delta = 0.00002, step_size_labels = 0.0001, num_evals = 10000L, delta_proposal_mean = -2, delta_proposal_sd = 0.3, alpha = 0.2, delta_adaption_block = 100L, M_proposal = 10L, n_Ensambler_sampler = 5L, Mass_mat = NULL) {
    .Call('_NeuralComp_Mixed_Sampler', PACKAGE = 'NeuralComp', X_A, X_B, X_AB, n_A, n_B, n_AB, MCMC_iters, Warm_block1, Warm_block2, init_position, Leapfrog_steps, I_A_shape, I_A_rate, I_B_shape, I_B_rate, sigma_A_mean, sigma_A_shape, sigma_B_mean, sigma_B_shape, delta_shape, delta_rate, eps_step, step_size, step_size_delta, step_size_labels, num_evals, delta_proposal_mean, delta_proposal_sd, alpha, delta_adaption_block, M_proposal, n_Ensambler_sampler, Mass_mat)
}

Mixed_Sampler_int <- function(X_A, X_B, X_AB, n_A, n_B, n_AB, MCMC_iters, Warm_block1 = 200L, Warm_block2 = 300L, init_position = NULL, Leapfrog_steps = 10L, I_A_shape = 40, I_A_rate = 1, I_B_shape = 40, I_B_rate = 1, sigma_A_mean = 6.32, sigma_A_shape = 1, sigma_B_mean = 6.32, sigma_B_shape = 1, delta_shape = 0.01, delta_rate = 0.1, eps_step = NULL, step_size = 0.001, step_size_delta = 0.00002, step_size_labels = 0.0001, num_evals = 10000L, delta_proposal_mean = -2, delta_proposal_sd = 0.3, alpha = 0.2, delta_adaption_block = 100L, M_proposal = 10L, n_Ensambler_sampler = 5L, Mass_mat = NULL) {
    .Call('_NeuralComp_Mixed_Sampler_int', PACKAGE = 'NeuralComp', X_A, X_B, X_AB, n_A, n_B, n_AB, MCMC_iters, Warm_block1, Warm_block2, init_position, Leapfrog_steps, I_A_shape, I_A_rate, I_B_shape, I_B_rate, sigma_A_mean, sigma_A_shape, sigma_B_mean, sigma_B_shape, delta_shape, delta_rate, eps_step, step_size, step_size_delta, step_size_labels, num_evals, delta_proposal_mean, delta_proposal_sd, alpha, delta_adaption_block, M_proposal, n_Ensambler_sampler, Mass_mat)
}
...
forward_pass1 <- function(theta, X_AB, step_size, num_evals) {
    .Call('_NeuralComp_forward_pass1', PACKAGE = 'NeuralComp', theta, X_AB, step_size, num_evals)
}
...
FFBS_labels <- function(X_AB, n_AB, theta, step_size, num_evals, MCMC_iters) {
...
FFBS_ensemble <- function(X_AB, n_AB, theta, MCMC_iters, step_size = 0.0001, num_evals = 10000L, delta_proposal_mean = -2, delta_proposal_sd = 0.5, M_proposal = 10L, delta_shape = 0.5, delta_rate = 0.1, alpha = 0.2) {
    .Call('_NeuralComp_FFBS_ensemble', PACKAGE = 'NeuralComp', X_AB, n_AB, theta, MCMC_iters, step_size, num_evals, delta_proposal_mean, delta_proposal_sd, M_proposal, delta_shape, delta_rate, alpha)
}
...
posterior_Labels1 <- function(Labels, X_AB, theta) {
    .Call('_NeuralComp_posterior_Labels1', PACKAGE = 'NeuralComp', Labels, X_AB, theta)
}
