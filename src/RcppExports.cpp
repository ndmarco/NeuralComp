...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(WAIC_Competition(X_A, X_B, X_AB, n_A, n_B, n_AB, Results, basis_degree, boundary_knots, internal_knots, time_inhomogeneous, burnin_prop, max_time, n_eval));
    return rcpp_result_gen;
END_RCPP
}
// WAIC_IGP
